...
def read_options():
    ...
    parser.add_argument("--sample_type",
                        type=str,
                        choices=['uniform', 'group', 'responsiveness',
...
def main():
    ...
    avail_prob_file = os.path.join('./data', dataset_name + options['dirichlet'], 'data',
                                   'avail_prob_{}_{}.pkl'.format(options['participation_level'],
                                                                 options['participation_pattern']))
